...
| **Atalhos de Teclado**        | **@tanstack/react-hotkeys**                        | Navegação rápida por teclado para investidores e _power users_.                                                                                                                       |
...
3. **Resultado:** O HTML inicial chega completo para os robôs de busca (Googlebot), e o navegador assume o estado sem requisições adicionais ou _layout shift_.
...
- **Estratégias de Cache no Service Worker:**
  - **Páginas de Ativos (`/etf/*`, `/bdr/*`):** _Stale-While-Revalidate_ — exibe imediatamente a versão salva em cache do ETF e atualiza silenciosamente em segundo plano.
  - **Simulador de Backtest e Calculadoras:** _Cache-First_ para assets e rotas, permitindo simulações de carteiras já cacheadas mesmo no metrô ou sem sinal de internet.
