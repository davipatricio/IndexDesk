...
function CommandDialog({
  ...
  children,
  ...props
}: CommandDialogPrimitive.Root.Props & { children: React.ReactNode }) {
  return (
    <CommandDialogPrimitive.Root open={open} onOpenChange={onOpenChange} {...props}>
      <CommandDialogPrimitive.Portal>
        ...
        <CommandDialogPrimitive.Popup
          className={cn(
            'fixed top-[15%] left-1/2 z-50 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 overflow-hidden rounded-xl border bg-popover text-popover-foreground shadow-lg transition duration-150 data-ending-style:opacity-0 data-ending-style:translate-y-1 data-starting-style:opacity-0 data-starting-style:translate-y-1',
          )}
        >
