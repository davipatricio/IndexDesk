...
**Status:** ⬜ `not_started` · **Prioridade:** `P0` · **Progresso:** [░░░░░░░░░░░░░░░░░░░░] 0% (0/22)
...
**Status:** ⬜ `not_started` · **Prioridade:** `P0` · **Progresso:** [░░░░░░░░░░░░] 0% (0/6)

| ID | Tarefa | Prioridade | Dificuldade | Status | Dependências |
| :--- | :--- | :---: | :---: | :--- | :--- | 
| `MVP-001` | Implementar scheduler Quartz do Worker | `P0` | `hard` | ⬜ `not_started` | `FND-008`, `FND-010`, `FND-012`, `FND-015` |
| `MVP-002` | Ingerir BCB SGS e calendário macro | `P0` | `medium` | ⬜ `not_started` | `MVP-001`, `FND-013` |
| `MVP-003` | Implementar ingestão CVM streaming | `P0` | `complex` | ⬜ `not_started` | `MVP-001`, `FND-013` |
| `MVP-004` | Ingerir Brapi, Yahoo e feeds de preços | `P0` | `hard` | ⬜ `not_started` | `MVP-001`, `FND-013` |
| `MVP-005` | Ingerir B3, ANBIMA e composição de gestoras | `P1` | `hard` | ⬜ `not_started` | `MVP-001`, `MVP-003` |
| `MVP-006` | Aplicar resiliência, idempotência e cache | `P0` | `hard` | ⬜ `not_started` | `MVP-002`, `MVP-003`, `MVP-004`, `MVP-005` |
...
**Status:** ⬜ `not_started` · **Prioridade:** `P0` · **Progresso:** [░░░░░░░░░░░░] 0% (0/2)

| ID | Tarefa | Prioridade | Dificuldade | Status | Dependências |
| :--- | :--- | :---: | :---: | :--- | :--- | 
| `MVP-007` | Implementar MarketData APIs | `P0` | `hard` | ⬜ `not_started` | `MVP-006` |
| `MVP-008` | Implementar Analytics APIs | `P0` | `complex` | ⬜ `not_started` | `MVP-002`, `MVP-004`, `MVP-007` |
